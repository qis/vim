...
fun! <sid>hi(group, fg, bg, attr, sp)
  if !empty(a:fg)
    exec "hi " . a:group . " guifg=" . a:fg.gui . " ctermfg=" .
      \ (g:codedark_term256 ? a:fg.cterm256 : a:fg.cterm)
  endif
  if !empty(a:bg)
    exec "hi " . a:group . " guibg=" . a:bg.gui . " ctermbg=" .
      \ (g:codedark_term256 ? a:bg.cterm256 : a:bg.cterm)
  endif
  if a:attr != ""
...
let s:cdPopupBack          = { 'gui': '#1E1E1E', 'cterm': s:cterm00, 'cterm256':  '234' }
...
" Gutter
" =======================================================================================
call <sid>hi('GitSignsAdd', s:cdGreen, {}, 'bold', {})
call <sid>hi('GitSignsChange', s:cdYellow, {}, 'bold', {})
call <sid>hi('GitSignsDelete', s:cdRed, {}, 'bold', {})
...
call <sid>hi('StatusVisualBold', s:cdBack, s:cdViolet, 'bold', {})
call <sid>hi('StatusInsert', s:cdBack, s:cdBlue, 'none', {})
call <sid>hi('StatusInsertBold', s:cdBack, s:cdBlue, 'bold', {})
...
" Diagnostics
" =======================================================================================
call <sid>hi('DiagnosticError', s:cdLightRed, {}, 'none', {})
call <sid>hi('DiagnosticWarn', s:cdYellow, {}, 'none', {})
call <sid>hi('DiagnosticInfo', s:cdLightBlue, {}, 'none', {})
call <sid>hi('DiagnosticHint', s:cdGray, {}, 'none', {})

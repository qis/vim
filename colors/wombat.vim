...
hi Directory    ctermfg=111               cterm=none guifg=#88b8f6               gui=none
...
hi ErrorMsg     ctermfg=196  ctermbg=236  cterm=bold guifg=#e3e0d7 guibg=#3a3a3a gui=bold
hi SpellBad     ctermfg=196  ctermbg=236  cterm=bold guifg=#e3e0d7 guibg=#3a3a3a gui=bold
hi SpellCap     ctermfg=196  ctermbg=236  cterm=bold guifg=#e3e0d7 guibg=#3a3a3a gui=bold
...
hi Todo         ctermfg=101               cterm=none guifg=#857b6f               gui=bold

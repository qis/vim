...
sudo apt install clang-11 llvm-11 lld-11 libc++-11-dev libc++abi-11-dev libclang-11-dev
...
```sh
for i in clang{,++,d,-{cpp,format,tidy}} lld{,b{,-instr,-server,-vscode}} llvm-{config,ar,as,nm,ranlib}; do
